	...
	<div class="content row">					
		<section class="main col col-sm-8">	
			...
			<section id="about-venue" class="media">
					...
					<img class="media-object pull-left" src="images/hotels/contempo.jpg" alt="Hotel Contempo" />					
			...
			<section class="other-venues">
				...
				<ul class="media-list">
					<li class="media">
						<h3 class="media-heading">Gwendoline's Fancy</h3>						
						<div class="pull-right">					
							<img class="media-object img-rounded" src="images/hotels/gwendoline.jpg" data-toggle="tooltip" title="Gwendoline" />
						</div>							
						<div class="media-body">
					...
					<li class="media">
						<h3 class="media-heading">The Otter Renaissance Hotel</h3>
						<div class="pull-right">					
							<img class="media-object img-rounded" src="images/hotels/otter.jpg" data-toggle="tooltip" title="Otter" />
						</div>
						<div class="media-body">
							<p>Hotel founder, Henry Chasings, had a love of otters, having been raised in an Alaskan village where otters played out his back door. As his tribute to the sea creatures of his early days, Henry was insistent upon having an otter in every hall, wall, and room inside the Otter Renaissance Hotel. In all, there are said to be 11,853 individuals otter within the hotel, and any guest that can successfully list 150 of them earns a complimentary one-night stay for two, with a full 6-course meal, including the otter's favorite food - oysters on the half shell.</p>
						</div>
					</li>

					<li class="media">
						<h3 class="media-heading">Phillips of Belltown</h3>						
						<div class="pull-right">					
							<img class="media-object img-rounded" src="images/hotels/phillips.jpg" data-toggle="tooltip" title="Phillips" />
						</div>
						<div class="media-body">
							<p>Situated amongst the hip, youthful culture of Downtown Seattle, Phillips of Belltown is the place to be any time of the day or night. Choose from Jazz and Rock music at the various music venues, and shop until you drop at an assortment of thrift stores and upscale boutiques. The hotel itself is a historical gem, with architectural achievements in every beam, brick, and support, and the rooms are fit for a king or queen, and have house many over the years when royalty has visited the area.</p>
						</div>
					</li>

					<li class="media">
						<h3 class="media-heading">The Rage Hotel</h3>		
						<div class="pull-right">					
							<img class="media-object img-rounded" src="images/hotels/rage.jpg" data-toggle="tooltip" title="Rage" />
						</div>
						<div class="media-body">
